# Generated by Django 4.0.2 on 2022-02-06 14:19

from django.db import migrations
from healthhacks.models import *

def populate_database(apps, schema_editor):
    fitness_plan_1 = FitnessPlan(days=1, workout_desc="Cardio is recommend 2-3 times a week and for overall cardiovascular health and can done in the form "
    ...
    fitness_plan_2 = FitnessPlan(days=2, workout_desc="Cardio is recommend 2-3 times a week and for overall cardiovascular health and can done in the form "
                    "of walking, running, biking, ext." +
                    "<br><br>(Option 1) The full body workout is recommended for those who want to increase overall strength and "
                    "don’t have much time in their schedule to workout. This plan consists of a few exercises to "
    ...
    fitness_plan_3 = FitnessPlan(days=3, workout_desc="Cardio is recommend 2-3 times a week and for overall cardiovascular health and can done in the form "
    ...
    fitness_plan_4 = FitnessPlan(days=4, workout_desc="Cardio is recommend 2-3 times a week and for overall cardiovascular health and can done in the form "
                    "of walking, running, biking, ext."+
    ...
    fitness_plan_5 = FitnessPlan(days=5, workout_desc="Cardio is recommend 2-3 times a week and for overall cardiovascular health and can done in the form "
                    "of walking, running, biking, ext."+
    ...
    fitness_plan_6 = FitnessPlan(days=6, workout_desc="Cardio is recommend 2-3 times a week and for overall cardiovascular health and can done in the form "
                    "of walking, running, biking, ext."+"<br><br>(Option 1) This workout plan encompasses multiple muscle groups in the same day. "
                                    "This style works antagonist muscles to ensure that muscles being worked have alternate rest periods." +
                                    "<br> <br> <b> 3-4 sets of 10-12 reps for all exercises </b>" + "<br> <br><b> Day 1: Chest + Back + Abs:</b>" +
                                    "<br> Barbell Chest Press " + "<br> Cable Pulldown" + "<br> Barbell Incline Press" + "<br> Barbell Bent Over Row" +
